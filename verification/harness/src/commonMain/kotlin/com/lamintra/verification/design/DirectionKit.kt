...
/**
 * Shared vocabulary for the harness's own screens, plus the slider, which is
 * still a prototype rather than a registry component.
 *
 ...
 * into the registry and deleted from this file**, and the segmented control
 * followed them on 2026-08-10. Keeping a second copy is the exact drift this
 * project has been bitten by; the registry sources are staged into this
 * harness by the build, so what the screens render is what `lamintra add`
 * ships.
 */
